...
test_sim_fig_paper<-function(object,maintitle=""){
	...
	plot(x,seq(0.1,1,by=.1),pch=".",col="white",xlab="Correlation ",
		...
		cex.lab=2.5*0.36, cex.axis=2*0.36, cex.main=3.5*0.36, cex.sub=2.5*0.36)
	...
	for(i in 1:len1){
		...
		# plot everything
		lines(x=x,y=y1,col=cols1[1],lwd=3*0.36)
		#lines(x=x,y=y2,col=2,lwd=3)
		lines(x=x,y=y3,col=cols3[1],lwd=3*0.36)
		lines(x=x,y=y4,col=cols4[1],lwd=3*0.36)
		lines(x=x,y=y5,col=cols5[1],lwd=3*0.36)
	...
	# plot everything
	lines(x=x,y=means[,1],col=cols1[2],lwd=3*0.36)
	#lines(x=x,y=y2,col=2,lwd=3)
	lines(x=x,y=means[,3],col=cols3[2],lwd=3*0.36)
	lines(x=x,y=means[,4],col=cols4[2],lwd=3*0.36)
	lines(x=x,y=means[,5],col=cols5[2],lwd=3*0.36)

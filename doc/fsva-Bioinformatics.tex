...
The methods we have developed here are available as part of the \texttt{sva} Bioconductor package \cite{Leek2012b}. Code and data to reproduce this project is available at \url{https://github.com/hilaryparker/fSVA}.

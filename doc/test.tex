...
Study & No Correction &  Improvement with fSVA \\
  \hline
GSE10927 & \textbf{0.965} (0.959, 0.972) 
		 & \textbf{0.017} (0.012, 0.023) \\
GSE13041 & \textbf{0.613} (0.592, 0.635) 
		 & \textbf{0.074} (0.052, 0.096) \\
GSE13911 & \textbf{0.934} (0.927, 0.941) 
		 & \textbf{0.009} (0.004, 0.014) \\
GSE2034 & \textbf{0.506} (0.488, 0.523) 
		& \textbf{0.033} (0.013, 0.053) \\
GSE2603  & \textbf{0.676} (0.656, 0.697) 
		 & \textbf{-0.019} (-0.037, \ensuremath{1.341\times 10^{-5}}) \\
GSE2990  & \textbf{0.594} (0.578, 0.61) 
		 & \textbf{-0.016} (-0.036, 0.003) \\
GSE4183  & \textbf{0.895} (0.881, 0.908) 
		 & \textbf{-0.017} (-0.03, -0.003) \\
GSE6764  & \textbf{0.737} (0.715, 0.759) 
		 & \textbf{0.012} (-0.011, 0.035) \\
GSE7696  & \textbf{0.776} (0.76, 0.792) 
		 & \textbf{0.021} (0.006, 0.037) \\
   \hline
   & \\
\end{tabular}

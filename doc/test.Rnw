...
createtab<-function(res){
	...
	tmp2<-mean(res$none.out)-1.96*sd(res$none.out)/sqrt(100)
	tmp3<-mean(res$none.out)+1.96*sd(res$none.out)/sqrt(100)
	
	tmp4<-mean(res$exact.out)
	tmp5<-mean(res$exact.out)-1.96*sd(res$exact.out)/sqrt(100)
	tmp6<-mean(res$exact.out)+1.96*sd(res$exact.out)/sqrt(100)
	
	diffen<-res$exact.out-res$none.out
	tmp7<-mean(diffen)
	tmp8<-mean(diffen)-1.96*sd(diffen)/sqrt(100)
	tmp9<-mean(diffen)+1.96*sd(diffen)/sqrt(100)
	
	tabvals<-c(tmp1,tmp2,tmp3,tmp4,tmp5,tmp6,tmp7,tmp8,tmp9)
	return(tabvals)
}
...
Study & No Correction &  Improvement with fSVA \\
  \hline
GSE10927 & \textbf{\Sexpr{row1[1]}} (\Sexpr{row1[2]}, \Sexpr{row1[3]}) 
		 & \textbf{\Sexpr{row1[7]}} (\Sexpr{row1[8]}, \Sexpr{row1[9]}) \\
GSE13041 & \textbf{\Sexpr{row2[1]}} (\Sexpr{row2[2]}, \Sexpr{row2[3]}) 
		 & \textbf{\Sexpr{row2[7]}} (\Sexpr{row2[8]}, \Sexpr{row2[9]}) \\
GSE13911 & \textbf{\Sexpr{row3[1]}} (\Sexpr{row3[2]}, \Sexpr{row3[3]}) 
		 & \textbf{\Sexpr{row3[7]}} (\Sexpr{row3[8]}, \Sexpr{row3[9]}) \\
GSE2034 & \textbf{\Sexpr{row4[1]}} (\Sexpr{row4[2]}, \Sexpr{row4[3]}) 
		& \textbf{\Sexpr{row4[7]}} (\Sexpr{row4[8]}, \Sexpr{row4[9]}) \\
GSE2603  & \textbf{\Sexpr{row5[1]}} (\Sexpr{row5[2]}, \Sexpr{row5[3]}) 
		 & \textbf{\Sexpr{row5[7]}} (\Sexpr{row5[8]}, \Sexpr{row5[9]}) \\
GSE2990  & \textbf{\Sexpr{row6[1]}} (\Sexpr{row6[2]}, \Sexpr{row6[3]}) 
		 & \textbf{\Sexpr{row6[7]}} (\Sexpr{row6[8]}, \Sexpr{row6[9]}) \\
GSE4183  & \textbf{\Sexpr{row7[1]}} (\Sexpr{row7[2]}, \Sexpr{row7[3]}) 
		 & \textbf{\Sexpr{row7[7]}} (\Sexpr{row7[8]}, \Sexpr{row7[9]}) \\
GSE6764  & \textbf{\Sexpr{row8[1]}} (\Sexpr{row8[2]}, \Sexpr{row8[3]}) 
		 & \textbf{\Sexpr{row8[7]}} (\Sexpr{row8[8]}, \Sexpr{row8[9]}) \\
GSE7696  & \textbf{\Sexpr{row9[1]}} (\Sexpr{row9[2]}, \Sexpr{row9[3]}) 
		 & \textbf{\Sexpr{row9[7]}} (\Sexpr{row9[8]}, \Sexpr{row9[9]}) \\
   \hline
   & \\
\end{tabular}

...
pdf(file="doc/testsimfigpaper.pdf",height=21,width=9.43)
...
Study & No Correction &  Improvement with fSVA \\
  \hline
GSE10927 & \textbf{\Sexpr{sprintf("%.2f",row1[1])}}
				  (\Sexpr{sprintf("%.2f",row1[2])}, \Sexpr{sprintf("%.2f",row1[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row1[7])}}
				  (\Sexpr{sprintf("%.2f",row1[8])}, \Sexpr{sprintf("%.2f",row1[9])})  \\
GSE13041 & \textbf{\Sexpr{sprintf("%.2f",row2[1])}}
				  (\Sexpr{sprintf("%.2f",row2[2])}, \Sexpr{sprintf("%.2f",row2[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row2[7])}}
				  (\Sexpr{sprintf("%.2f",row2[8])}, \Sexpr{sprintf("%.2f",row2[9])})  \\
GSE13911 & \textbf{\Sexpr{sprintf("%.2f",row3[1])}}
				  (\Sexpr{sprintf("%.2f",row3[2])}, \Sexpr{sprintf("%.2f",row3[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row3[7])}}
				  (\Sexpr{sprintf("%.2f",row3[8])}, \Sexpr{sprintf("%.2f",row3[9])})  \\
GSE2034  & \textbf{\Sexpr{sprintf("%.2f",row4[1])}}
				  (\Sexpr{sprintf("%.2f",row4[2])}, \Sexpr{sprintf("%.2f",row4[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row4[7])}}
				  (\Sexpr{sprintf("%.2f",row4[8])}, \Sexpr{sprintf("%.2f",row4[9])})  \\
GSE2603  & \textbf{\Sexpr{sprintf("%.2f",row5[1])}}
				  (\Sexpr{sprintf("%.2f",row5[2])}, \Sexpr{sprintf("%.2f",row5[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row5[7])}}
				  (\Sexpr{sprintf("%.2f",row5[8])}, \Sexpr{sprintf("%.2f",row5[9])})  \\
GSE2990  & \textbf{\Sexpr{sprintf("%.2f",row6[1])}}
				  (\Sexpr{sprintf("%.2f",row6[2])}, \Sexpr{sprintf("%.2f",row6[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row6[7])}}
				  (\Sexpr{sprintf("%.2f",row6[8])}, \Sexpr{sprintf("%.2f",row6[9])})  \\
GSE4183  & \textbf{\Sexpr{sprintf("%.2f",row7[1])}}
				  (\Sexpr{sprintf("%.2f",row7[2])}, \Sexpr{sprintf("%.2f",row7[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row7[7])}}
				  (\Sexpr{sprintf("%.2f",row7[8])}, \Sexpr{sprintf("%.2f",row7[9])})  \\
GSE6764  & \textbf{\Sexpr{sprintf("%.2f",row8[1])}}
				  (\Sexpr{sprintf("%.2f",row8[2])}, \Sexpr{sprintf("%.2f",row8[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row8[7])}}
				  (\Sexpr{sprintf("%.2f",row8[8])}, \Sexpr{sprintf("%.2f",row8[9])})  \\
GSE7696  & \textbf{\Sexpr{sprintf("%.2f",row9[1])}}
				  (\Sexpr{sprintf("%.2f",row9[2])}, \Sexpr{sprintf("%.2f",row9[3])}) 
		 & \textbf{\Sexpr{sprintf("%.2f",row9[7])}}
				  (\Sexpr{sprintf("%.2f",row9[8])}, \Sexpr{sprintf("%.2f",row9[9])})  \\
\hline
 & \\
\end{tabular}
